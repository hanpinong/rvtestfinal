...
$("#D2D").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [   
"par_d2d_gt",
...
$("#HBO_MFS").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
"par_mfs_data0",
...
$("#sfc_ddr").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
"ddrdata",
...
$("#sfc_mem").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
"par_cce",
...
$("#sfc_vpu").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
"par_nce_cim",
...
$("#sfc_display").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
"par_disp_buttress",
...
$("#sfc_ipu").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
"par_ipu_buttress",
...
$("#sfc_media").on('click', null, function raw_filter_search_buttons() {
	var rows2 = $('table tbody tr');
	rows2.hide()
 	var flowfiltered= [  
"par_smdecode11",
